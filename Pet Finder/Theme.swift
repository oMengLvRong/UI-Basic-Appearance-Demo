...
struct ThemeManager {
    ...
    static func applyTheme(theme: Theme) {
        ...
        shareApplication.delegate?.window??.tintColor = theme.mainColor
        ...
        let tabResizeableIndicator = tabIndicator?.resizableImageWithCapInsets(UIEdgeInsets(top: 0, left: 2.0, bottom: 0, right: 2.0))
